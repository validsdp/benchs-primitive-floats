...
idtac "RD".
Time intros x1 x2 x3 H1 H2 H3; interval with (i_prec 30, i_bisect x2).
Qed.
*)
...
idtac "adaptiveLV".
Time intros x1 x2 x3 x4 H1 H2 H3 H4; interval with (i_prec 30, i_bisect x1, i_autodiff x1).
Qed.
...
Time intros x1 x2 x3 x4 x5 x6 H1 H2 H3 H4 H5 H6;
  interval with (i_prec 30, i_bisect x4, i_autodiff x4).
Qed.
...
interval with (i_prec 30, i_bisect x1, i_autodiff x1).
Qed.
...
Proof.
idtac "MT1".
Time intros x H; apply Rminus_le; interval with (i_prec 30, i_bisect x).
Qed.
...
Proof.
idtac "MT2".
Time intros x H; apply Rminus_le; interval with (i_prec 30, i_bisect x, i_taylor x).
Qed.
...
Proof.
idtac "MT5".
Time intros x [H|H]; apply Rminus_lt; interval with (i_prec 30, i_bisect x).
Qed.
...
Proof.
idtac "MT7".
Time intros x H; apply Rminus_le; interval with (i_prec 30, i_bisect x, i_autodiff x).
Qed.
...
Proof.
idtac "MT17".
Time intros x H; apply Rminus_lt; interval with (i_prec 30, i_bisect x).
Qed.
...
Proof.
idtac "MT18".
Time intros x H; apply Rminus_ge; interval with (i_prec 30, i_bisect x).
Qed.
...
Proof.
idtac "MT19".
Time intros x H; apply Rminus_ge; interval with (i_prec 30, i_bisect x, i_autodiff x).
Qed.
...
Proof.
idtac "MT20".
Time intros x H; interval with (i_prec 30, i_bisect x, i_autodiff x, i_depth 25).
Qed.
...
Proof.
idtac "MT21".
Time intros x H; apply Rminus_lt; interval with (i_prec 30, i_bisect x, i_autodiff x).
Qed.
...
Proof.
idtac "MT22".
Time intros x H; apply Rminus_le; interval with (i_prec 30, i_bisect x, i_taylor x, i_depth 16).
Qed.
...
Proof.
idtac "MT23".
Time intros x H; apply Rminus_lt; interval with (i_prec 30, i_bisect x, i_taylor x).
Qed.
...
Proof.
idtac "MT24".
Time intros x H; interval with (i_prec 30, i_bisect x).
Qed.
...
Time intros x [H|H]; unfold c3, c4, p_2_55;
  interval with (i_bisect x, i_taylor x, i_prec 90). (* NOT i_prec 30 *)
Qed.
End CRlibm_exp.
 *)
...
idtac "remez_sqrt".
Time intros x H;
  (* interval with (i_prec 30, i_bisect x, i_autodiff x). OK but slower *)
  interval with (i_prec 30, i_bisect x, i_taylor x).
Qed.
...
idtac "abs_err_atan".
Time intros x H;
  interval with (i_prec 30, i_bisect x, i_autodiff x).
Qed.
...
Time unfold (*rp, arp,*) a, umf2, f, max; intros phi Hphi;
  interval with (i_prec 30, i_bisect phi, i_autodiff phi).
Qed.
...
idtac "rel_err_geodesic'".
Time unfold (*rp, arp,*) a, umf2, f, max; intros phi Hphi;
  interval with (i_prec 30, i_bisect phi, i_taylor phi).
Qed.
...
Lemma MT22' : forall x : R, eps <= x <= PI -> cos x < sin x / x.
idtac "MT22'".
Time intros x H; apply Rminus_lt; interval with (i_prec 30, i_bisect x, i_taylor x, i_depth 16).
Qed.
...
intros x Hx.
idtac "bug20120927".
Time interval_intro (Rabs x + x)%R upper with (i_prec 30, i_bisect x, i_autodiff x, i_depth 5).
exact I.
Qed.
*)
...
idtac "bug20140723_1".
Time interval_intro PI lower with (i_prec 30).
exact I.
Qed.
*)
...
idtac "bug20140723_2".
Time interval_intro (PI/2)%R upper with (i_prec 30).
exact I.
Qed.
*)
...
idtac "bug20140728".
Time intros; interval with (i_prec 30).
Qed.
...
intros x.
idtac "bug20150924".
Time interval with (i_prec 30, i_autodiff x).
Qed.
...
idtac "example20071016_3".
  Time interval_intro (sqrt (1 - x)) upper with (i_prec 30) as H'.
...
idtac "example20071016_4".
  Time interval with (i_prec 30, i_bisect x).
Qed.
...
idtac "example20071016_5".
  Time interval with (i_prec 30, i_bisect x, i_taylor x).
Qed.
...
idtac "example20071016_6".
  Time interval with (i_prec 30, i_bisect x, i_autodiff x).
Qed.
...
(* Time interval with (i_prec 30, i_integral_prec 9, i_integral_depth 1, i_integral_deg 5). **)
Time integral with (i_prec 30, i_fuel 2, i_degree 5).
Qed.
...
Time interval with (i_prec 30, i_bisect x, i_autodiff x, i_depth 16).
Qed.
*)
...
Time interval with (i_prec 30, i_bisect phi, i_autodiff phi).
Qed.
...
Time interval with (i_prec 30, i_bisect phi, i_taylor phi).
Qed.
...
Proof.
idtac "exp_0_3".
Time integral with (i_prec 30, i_fuel 1).
Qed.
...
Proof.
idtac "circle".
Time integral with (i_prec 30, i_fuel 7, i_degree 1).
Qed.
...
idtac "example_ln_2".
Time split; interval with (i_prec 30).
Qed.
...
idtac "bissect".
Time integral with (i_degree 13, i_fuel 13, i_prec 30).
Qed.
*)
...
idtac "Chebyshev".
Time integral with (i_degree 10, i_fuel 100, i_prec 30).
Qed.
*)
...
idtac "Rump_Tucker".
Time integral with (i_degree 7, i_fuel 4000, i_prec 30).
Qed.
*)
